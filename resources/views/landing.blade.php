...
@section('content')
    <div class="container vh-100 d-flex flex-column flex-md-row-reverse align-items-center" id="home">
        <div class="">
            <svg fill="#444" width="300px" height="300px" viewBox="0 0 100 100" id="Layer_1" version="1.1"
    ...
    <div class="container vh-100 d-flex flex-column justify-content-center align-items-stretch" id="service">
        ...
        <div class="content-service-container hw-100 d-flex flex-column flex-md-row">
            <div class="content-service">
                <h2 class="h3">Pantau perkembangan terapi</h2>
                <p>Lihat kembali hasil terapi anda dan evaluasi perkembangannya.</p>
                <img class=" "
                    src="https://img.freepik.com/free-photo/flat-lay-statistics-presentation-with-chart_23-2149023811.jpg?t=st=1709180915~exp=1709184515~hmac=a77d2e0158b84d9246a756ea4e0fdd903ad312ec39b27128b22a413cf0381880&w=1480"
